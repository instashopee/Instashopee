...
export default function Custom404(){
    return <section className="bg-white min-h-screen ">
        ...
        <div className="flex flex-col items-center max-w-sm mx-auto text-center my-[6rem]">
            ...
            <p className="mt-4 text-gray-800 ">The page you are looking for doesn't exist. Here are some helpful links:</p>
