...
const Footer = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    ...
    <div className='flex flex-col items-center my-5'>
      ...
      <br />
      {<Link legacyBehavior href={'https://www.facebook.com/instashopeeonline?mibextid=LQQJ4d'} target="_blank"><a target="_blank"><div className="flex sticky cursor-pointer mr-4 float-right shadow-xl py-3 border rounded-3xl p-10 bg-blue-500 ">
