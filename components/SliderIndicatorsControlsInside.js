      ...
      <div className="relative w-full glide-03">
        ...
        <div className="overflow-hidden" data-glide-el="track">
          ...
          {/* {Object.values(banners).map(item => ( <img className="w-full h-[40rem]" src={item.banner1} alt="" />
            ...
            <video  className="hidden md:block w-full h-full" muted  autoPlay={true} loop src="/banners/banner3.mp4" ></video>
            ...
            <video  className="hidden md:block w-full h-full" muted  autoPlay={true} loop src="/banners/banner2.mp4" ></video>
            ...
            <video  className="hidden md:block w-full h-full" muted  autoPlay={true} loop src="/banners/banner1.mp4" ></video> 
            ...
            <video  className="hidden md:block w-full h-full" muted  autoPlay={true} loop src="/banners/banner4.mp4" ></video>
