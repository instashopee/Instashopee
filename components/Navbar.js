  ...
  return (
    ...
    <div className="bg-white">
      ...
      <header className="relative bg-white">
        ...
        <div className="inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-400 border-2 border-white rounded-full -top-2 -right-2 dark:border-gray-900">{Object.keys(cart).length}</div>
        ...
        <div className="inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-400 border-2 border-white rounded-full -top-2 -right-2 dark:border-gray-900">{Object.keys(wishlist).length}</div>
      ...
      <div  className="hidden md:flex cursor-pointer items-center cart absolute right-0 top-12 mx-5">
...
<input
               ...
               name="search"
               className="w-full bg-white rounded   text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
        ...
        {user.value &&<a><div className="flex rounded-lg px-2 ">
...
<div className="md:hidden fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200">
    ...
    <Link legacyBehavior href={'/'}><a>{<button type="button" className="my-6 inline-flex flex-col items-center justify-center px-5">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-house-door-fill" viewBox="0 0 16 16 group">
  <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5Z"/>
</svg>
            <span className="text-sm text-gray-500 dark:text-gray-400">Home</span>
        </button>}</a></Link>
        <Link legacyBehavior href={'/all_products'}><a>{<button type="button" className="my-6 inline-flex flex-col items-center justify-center px-5 group">
  ...
  <path d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5l2.404.961L10.404 2l-2.218-.887zm3.564 1.426L5.596 5 8 5.961 14.154 3.5l-2.404-.961zm3.25 1.7-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923l6.5 2.6zM7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464L7.443.184z"/>
        ...
        <Link legacyBehavior href={'/cart'}><a>{<button type="button" className="inline-flex flex-col items-center justify-center px-5 mx-4 group">
        <div className="inline-flex items-center justify-center w-4 h-4 text-xs font-bold text-white bg-red-400 border-2 border-white rounded-full dark:border-gray-900">{Object.keys(cart).length}</div>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cart" viewBox="0 0 16 16">
  <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
</svg>

            <span className="text-sm text-gray-500 dark:text-gray-400 ">Cart</span>
        </button>}</a></Link>
        <Link legacyBehavior href={'/wishlist'}><a>{<button type="button" className="inline-flex flex-col items-center justify-center px-5 group">
<div className="inline-flex items-center justify-center w-4 h-4 text-xs font-bold text-white bg-red-400 border-2 border-white rounded-full  dark:border-gray-900">{Object.keys(wishlist).length}</div>
        <AiOutlineHeart className="text-lg"/>


            <span className="text-sm text-gray-500 dark:text-gray-400 ">Wishlist</span>
        </button>}</a></Link>
        <Link legacyBehavior href={'/login'}><a>{<button type="button" className="my-6 inline-flex flex-col items-center justify-center px-5 group">
  ...
  <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
      ...
      <div className="sm:hidden relative mt-1 mx-1">
  ...
  <div className="mb-1">
       ...
       {<button  id="myBtn" type="submit" onClick={submit} className="text-black absolute right-2.5 bottom-1 bg-red-400 font-medium rounded-lg text-sm px-4 py-2 ">Search</button>}
    </div>
    </div>
    </div>
...
//             </svg>
//         </div>
//         <input type="search" id="default-search" className="block w-[40vh] h-[5vh] p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-orange-500 focus:border-orange-500  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" placeholder="Search..." required/>
//         <button type="submit" className="h-[4vh] text-white absolute top-1 right-1 bg-orange-600 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-1 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">Search</button>
//     </div>
// </form>
...
// <div className="2xl:hidden fixed bottom-0 left-0 z-50 w-full h-16 bg-red-50 border-t border-gray-200">
//     <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
//     <Link legacyBehavior href={'/'}><a>{<button type="button" className="my-4 inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
...
//         </button>}</a></Link>
//         <Link legacyBehavior href={'/hinges'}><a>{<button type="button" className="my-4 inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
//         <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-box-seam" viewBox="0 0 16 16">
//   <path d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5l2.404.961L10.404 2l-2.218-.887zm3.564 1.426L5.596 5 8 5.961 14.154 3.5l-2.404-.961zm3.25 1.7-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923l6.5 2.6zM7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464L7.443.184z"/>
// </svg>
...
//         </button>
//         <Link legacyBehavior href={'/login'}><a>{<button type="button" className="my-4 inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
//         <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
//   <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
//   <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
// </svg>
