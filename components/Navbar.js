...
<div class="md:hidden fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200">
    ...
    <Link legacyBehavior href={'/'}><a>{<button type="button" class="my-6 inline-flex flex-col items-center justify-center px-5">
  ...
  <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5Z"/>
        ...
        <Link legacyBehavior href={'/all_products'}><a>{<button type="button" class="my-6 inline-flex flex-col items-center justify-center px-5 group">
  ...
  <path d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5l2.404.961L10.404 2l-2.218-.887zm3.564 1.426L5.596 5 8 5.961 14.154 3.5l-2.404-.961zm3.25 1.7-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923l6.5 2.6zM7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464L7.443.184z"/>
        ...
        <Link legacyBehavior href={'/cart'}><a>{<button type="button" class="inline-flex flex-col items-center justify-center px-5 mx-4 group">
        <div class="inline-flex items-center justify-center w-4 h-4 text-xs font-bold text-white bg-red-400 border-2 border-white rounded-full dark:border-gray-900">{Object.keys(cart).length}</div>
  ...
  <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
        ...
        <Link legacyBehavior href={'/wishlist'}><a>{<button type="button" class="inline-flex flex-col items-center justify-center px-5 group">
<div class="inline-flex items-center justify-center w-4 h-4 text-xs font-bold text-white bg-red-400 border-2 border-white rounded-full  dark:border-gray-900">{Object.keys(wishlist).length}</div>
        <AiOutlineHeart className="text-lg"/>


            <span class="text-sm text-gray-500 dark:text-gray-400 ">Wishlist</span>
        </button>}</a></Link>
        <Link legacyBehavior href={'/login'}><a>{<button type="button" class="my-6 inline-flex flex-col items-center justify-center px-5 group">
