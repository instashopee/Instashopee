        ...
        {/* <li>
         ...
         <li>
           <div class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white  group">
              ...
              <a href="file:///C:/Users/DELL/Documents/upload-image-to-github/dist/index.html"><span class="ml-3  p-2 hover:bg-gray-100 dark:hover:bg-gray-700 group text-blue-500 rounded-md">ADD</span></a>
