...
const Admin_sidebar = () => {
   const image=()=>{
      window.location="http://10.12.34.246:5500/index.html"
   }
  return (
   <div>

   <button data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar" aria-controls="sidebar-multi-level-sidebar" type="button" class="">
   ...
   <aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-80 h-screen transition-transform " aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
     <ul class="space-y-2 font-medium">
        ...
        {/* <li>
         ...
         <li>
           <div class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white  group">
              ...
              <a href="/admin/Add_Banner"><span class="ml-3 p-2 hover:bg-gray-100 dark:hover:bg-gray-700 group text-blue-500 rounded-md">ADD</span></a>
         ...
         <li>
           <div class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white  group">
              ...
              <a href="file:///Users/abhishekjain/Documents/PROGRAMMING/upload-image-to-github/dist/index.html"><span class="ml-3  p-2 hover:bg-gray-100 dark:hover:bg-gray-700 group text-blue-500 rounded-md">ADD</span></a>
              <span className="ml-3 font-semibold ">IMAGES</span>
              {/* <a href="/admin/add"><span class="ml-3 p-2 hover:bg-gray-100 dark:hover:bg-gray-700 group text-blue-500 rounded-md">EDIT</span></a> */}
        ...
        <li>
           <a href="/admin/allorders" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        ...
        <li>
           <a href="/admin/allusers" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
